...
struct Weave : Module {
   ...
   //WEAVE PATTERNS
    ...
    Weave() {
        ...
        configParam(WEAVE_ATT_PARAM, -1.f, 1.0, 1.f, "Weave Attenuverter");
        configParam(CHORD_KNOB_PARAM, 0.f, 1.41666f, 0.f, "");
        configInput(TRIG_INPUT, "Weave Trigger");
        ...
        configOutput(POLY_OUTPUT, "Poly CV");
